const schoolCards = [
  ...
  // src/data/schoolCards.js
  {
    id: 9,
    title: "ふくいICT中央高等学院",
    detailInfo: {
      location: "福井県坂井市坂井町新庄2-325", // ← "本校所在地"用
      phone: "0776-97-5509",
      ...
      fee: "所得640万円以下の世帯、週２回通学した場合①中央国際高校学費 3年間55万円くらい②サポート校費用 3年間120万円（修学旅行費用含む）、①＋②＝175万円（3年間）",
      uniform: "あり（自由）",
